  ...
  const handleAvatarClick = () => {
    ...
    input.onchange = (e) => {
      ...
      if (file) {
        ...
        // Crear imagen comprimida para preview y almacenamiento
        const canvas = document.createElement('canvas')
        const ctx = canvas.getContext('2d')!
        const img = new window.Image()
        
        img.onload = () => {
          // Redimensionar a máximo 200x200 px para ahorrar espacio
          const maxSize = 200
          ...
          // Convertir a base64 con calidad reducida (0.5 = 50% calidad para imágenes más pequeñas)
          let compressedBase64 = canvas.toDataURL('image/jpeg', 0.5)
          
          // Si la imagen sigue siendo muy grande, reducir más
          if (compressedBase64.length > 100000) { // Si es mayor a ~100KB
            compressedBase64 = canvas.toDataURL('image/jpeg', 0.3)
          }
          
          console.log("Imagen comprimida en registro, tamaño final:", (compressedBase64.length / 1024).toFixed(2) + "KB")
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <p className="text-xs text-muted-foreground text-center">
                Haz clic para {avatarPreview ? 'cambiar' : 'añadir'} tu foto de perfil
                <br />
                (Opcional - Máx. 5MB)
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full min-h-[80px] px-3 py-2 border border-border rounded-md bg-background resize-none focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  maxLength={300}
                />
            ...
            {/* Comentado temporalmente - Funcionalidad no implementada
