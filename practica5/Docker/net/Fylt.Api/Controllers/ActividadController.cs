    ...
    public class ActividadController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll(CancellationToken ct)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, ApiResponseBase.Fail("Error interno al obtener las actividades.", 500));
            }
        }
        ...
        public async Task<IActionResult> GetById([FromRoute] int idUser, CancellationToken ct)
        {
            ...
            {
                _logger.LogError(ex, "Error al obtener la actividad con ID_USER {IdUser}", idUser);
                return StatusCode(500, ApiResponseBase.Fail("Error interno al obtener la actividad.", 500));
            }
        }
        ...
        public async Task<IActionResult> Update([FromRoute] int idUser, [FromBody] ActividadVO actividad, CancellationToken ct)
        {
            ...
            {
                _logger.LogError(ex, "Error al actualizar la actividad con ID_USER {IdUser}", idUser);
                return StatusCode(500, ApiResponseBase.Fail("Error interno al actualizar la actividad.", 500));
            }
        }
        ...
        public async Task<IActionResult> Delete([FromRoute] int idUser, CancellationToken ct)
        {
            ...
            {
                _logger.LogError(ex, "Error al eliminar la actividad con ID_USER {IdUser}", idUser);
                return StatusCode(500, ApiResponseBase.Fail("Error interno al eliminar la actividad.", 500));
            }
        }
    }
}
