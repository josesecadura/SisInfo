...
export default function ReviewsPage() {
  ...
  // Datos de ejemplo locales (IDs negativos para no chocar con la BD)
    const initialReviews: Review[] = [
        {
            id: -1,
            user: "Usuario_777",
            movieTitle: "Baramulla",
            movieImage: "https://image.tmdb.org/t/p/w500/2raITTyjXVUcsbJ7lJAQt8HzjDK.jpg",
            review: "Esta película me pareció lenta, aunque tiene buena fotografía.",
            status: "pending",
        },
        {
            id: -2,
            ...
            movieImage: "https://image.tmdb.org/t/p/w500/iANU8C9n6lH7Wx0MbOdM4aATfrW.jpg",
            review: "Acción brutal, pero con buena historia. Recomendable.",
            status: "approved",
        },
        {
            id: -3,
            ...
            movieImage: "https://image.tmdb.org/t/p/w500/hTj8x0ElKldJyAjTYvaqxkQNxxN.jpg",
            review: "Una visión interesante del clásico, aunque algo lenta.",
            status: "rejected",
        },
    ]
        ...
        const load = async () => {
            ...
            // Para cada comentario, traemos los datos de la película (solo los que existan en BD)
                const moviePromises = payload.map(async (c) => {
                    try {
                        const movieRes = await apiClient.get<any>(`/api/Peliculas/${c.idPelicula}`)
        ...
        <main className="container mx-auto px-6 py-12">
            ...
            {currentReviews.map((review) => (
                ...
                <div className="flex gap-6">
                    ...
                    <Image src={review.movieImage || "/placeholder.svg"} alt={review.movieTitle} fill className="object-cover" />
                    </div>
